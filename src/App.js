...
import { Button, Navbar, Container, Nav, NavDropdown, Form, FormControl, Image} from "react-bootstrap";
...
function App() {
  ...
  return (
    ...
    <div className="App">
      <div onClick={scrollToBottom}>Bottom</div>
      <AppContainer>
        <AccountBox/>
      </AppContainer>
      <Router>
        ...
        <Navbar fixed="top" scrolling dark bg="light" expand="lg">
          <Container fluid>
            ...
            <Navbar.Collapse id="navbarScroll">
              ...
              navbarScroll>
                <Nav.Link onClick={() => scrollDown(aboutSection)}>Who am I?</Nav.Link>
      ...
      <p>
      <img src={logo} alt="Logo" style={{width:200, height:250}} />
      <div></div>
